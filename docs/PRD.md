...
3. Review and edit 5 generated queries.
4. Launch run (batch if supported, otherwise async queue).
5. Review graph UI (persona -> queries -> responses -> insight).
6. Read insight summary and charts; inspect citations and raw responses.
