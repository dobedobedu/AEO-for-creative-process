...
export function getGalleryTileCardBaseClass(): string {
  return "h-full border-[#e3dacb] hover:border-black/20 transition-all duration-300 rounded-none border-t-0 border-l-0 border-r-0 shadow-none p-5 flex flex-col gap-0";
}
